    ...
    public class ProductoesController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (producto != null)
            {
                ...
                {
                    // Aquí capturamos el error de la FK
                    // Puedes registrar el error si quieres: ex.InnerException?.Message
                    TempData["ErrorMessage"] = "No se puede eliminar este producto porque está relacionado con ventas.";
                    return RedirectToAction(nameof(Index));
                }
