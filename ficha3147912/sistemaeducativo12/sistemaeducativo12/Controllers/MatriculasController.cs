...
namespace sistemaeducativo12.Controllers
{
    [Authorize]
    public class MatriculasController : Controller
    {
        ...
        {
            var sistemaeducativoContext = _context.Matriculas.Include(m => m.IdCursoNavigation).Include(m => m.IdEstudianteNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdMatricula,IdEstudiante,IdCurso,FechaMatricula")] Matricula matricula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMatricula,IdEstudiante,IdCurso,FechaMatricula")] Matricula matricula)
        {
